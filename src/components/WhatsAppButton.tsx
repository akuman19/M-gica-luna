...
const WHATSAPP_NUMBER = "573001234567"; // Número de WhatsApp sin + ni espacios
const WHATSAPP_MESSAGE = "Hola! Me interesa conocer más sobre Terra Luna Glamping y hacer una reserva.";
